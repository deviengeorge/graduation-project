...
SECRET_KEY = "django-insecure-*8p37$lciuy#t@_0-#wm#s3u-f@la%ktdjzlcg0g42y&x8g&mz"
...
# To use your custom user model in Authentication Folder
AUTH_USER_MODEL = "authentication.User"


# To log all sql queries into the terminal
# LOGGING = {
#     'version': 1,
